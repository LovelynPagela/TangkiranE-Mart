...
<nav class="navbar">
        <div>
            <a class="navbar-brand" href="index.php">CSU-G BAMBOOLINK</a>
        </div>
        <?php if (is_logged_in()): ?>
            <div style="position: relative; display: inline-block;">
                ...
                <div id="userMenu" style="display: none; position: absolute;top: 40px;right: 0; background-color: #f1f1f1;border: 1px solid #ccc;border-radius: 5px;padding: 10px;z-index: 1000;box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); width: 160px;">
                    <a href="account.php" style="display: block; padding: 5px 10px; text-decoration: none; color: black;">Manage Account</a>
...
<h2 class="mb-4">BAMBOO SHOP</h2>
    <div id="search" style="align-items: center; justify-content: center; display: flex">
        <form class="d-flex" method="get" action="search_results.php">
            <input class="form-control me-2" type="search" name="search" style="width: 200px" placeholder="Search products..." aria-label="Search" value="<?= htmlspecialchars($search) ?>">
